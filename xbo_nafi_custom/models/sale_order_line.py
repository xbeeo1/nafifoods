...
class SaleOrderLineInherit(models.Model):
    ...
    def _prepare_invoice_line(self, **optional_values):
        ...
        res.update({
            'dist_margin': self.dist_margin or 0.0,
            'booker_margin': self.booker_margin or 0.0,
            'trade_Offer': self.trade_Offer or 0.0,
            'trade_price': self.trade_price or 0.0,
        })
        return res
    ...
    def _compute_all_margins_and_price(self):
        ...
        for line in self:
            ...
            if line.trade_Offer:
                ...
                line.technical_price_unit = line.trade_Offer
            elif line.booker_margin:
                line.price_unit = line.booker_margin
                line.technical_price_unit = line.booker_margin
            elif line.dist_margin:
                line.price_unit = line.dist_margin
                line.technical_price_unit = line.dist_margin
            else:
                line.price_unit = trade_price
                line.technical_price_unit = trade_price
    ...
    def _reset_price_unit(self):
        ...
        for line in self:
            if line.trade_Offer:
                price = line.trade_Offer
            elif line.booker_margin:
                price = line.booker_margin
            elif line.dist_margin:
                price = line.dist_margin
            else:
                price = line.trade_price or 0.0
